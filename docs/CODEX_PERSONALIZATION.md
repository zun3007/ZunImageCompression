...
- `Personality`
  - `Pragmatic`
- `Custom instructions`
  - use the exact content from [AGENTS.md](D:/Project/ZunImageCompress/AGENTS.md)

## Why This Setup

- `Pragmatic`
  - keeps responses direct, implementation-focused, and low-fluff
- custom instructions from [AGENTS.md](D:/Project/ZunImageCompress/AGENTS.md)
...
4. Copy the full content of [AGENTS.md](D:/Project/ZunImageCompress/AGENTS.md).
...
- Repo-level instruction source:
  - [AGENTS.md](D:/Project/ZunImageCompress/AGENTS.md)
- If you update the instruction style later:
  - update [AGENTS.md](D:/Project/ZunImageCompress/AGENTS.md)
